...
def search_password():
    ...
    try:
        ...
        messagebox.showerror(title="Error", message="No data file found. Save some passwords first!")
        return
...
search_button = tk.Button(text="Search", width=36, command=search_password)
search_button.grid(column=1, row=5, columnspan=2)
